...
server_address = ('192.168.215.217', 12345)
client_socket.connect(server_address)
player_Xlocs =[430,390,522,654,786,918,1050,1050,918,786,654,522,390,390,522,654,786,918,1050,1050,918,786,654,522,390,390,522,654,786,918,1050,390,522,654,786,918,1050]
player2_Xlocs = [490,440,572,704,836,968,1100,1100,968,836,704,572,440,440,572,704,836,968,1100,1100,968,836,704,572,440,440,572,704,836,968,1100,440,572,704,836,968,1100]
...
def on_button_click():
    ...
    player1.place(x=player_Xlocs[int(where)],y=player_Ylocs[int(where)])
    where = client_socket.recv(1024).decode('utf-8')
    player1.place(x=player_Xlocs[int(where)],y=player_Ylocs[int(where)])
...
def recvv():
    where = client_socket.recv(1024).decode('utf-8')
    player2.place(x=player2_Xlocs[int(where)],y=player_Ylocs[int(where)])
    where = client_socket.recv(1024).decode('utf-8')
    player2.place(x=player2_Xlocs[int(where)],y=player_Ylocs[int(where)])
